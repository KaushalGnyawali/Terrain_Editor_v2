            ...
            if geom_type == "LineString" and st.session_state.design_mode == "basin":
                ...
                if len(channel_coords) >= 2:
                    ...
                    if is_new_channel:
                        ...
                        # CRITICAL FIX: Trigger rerun so the map re-renders with the saved polyline displayed
                        # This is essential for the polyline to persist and stations (S0/S1) to render immediately
                        st.rerun()
